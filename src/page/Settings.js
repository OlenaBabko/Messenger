...
// ============================================
// Імпортуємо компонент "Список опцій",  "Шапка", "Меню", "Сторінка" ...
...
// title - це текст для назви нашої опції
...
const SettingsView = styled.div`
    display: grid;          /* надаємо систему верстки grid */
    gap: 30px;              /* робимо вертикальні відступи для списку опцій */
`;
